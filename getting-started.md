...
Once the project has been created, change directory to the project's directory, where `example-dashboards` is the artifactId you chose above:

``` bash
$ cd example-dashboards
```
...
The project contains the following sub-directories:

* components - contains any custom [React](https://facebook.github.io/react/) based UI components that can be used on the dashboards
* dashboards - contains the dashboards.  The dashbaords are also [React](https://facebook.github.io/react/) based.
* src - contains the Java source code that loads the metric collectors that feed the dashboards with data
